<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="{{ route('home') }}">   
            ...
            <br><h3 class="mt-2">Omega Secondary <br>School</h3>
        </a>
        <!-- User -->
            ...
            <ul class="navbar-nav font-weight-bold">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/admin/news">
                        <i class="ni ni-app text-red"></i>News Management
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/events">
                        <i class="ni ni-books text-red"></i>Events Management
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/admission">
                        <i class="ni ni-app text-red"></i>Admission Requests
                    </a>
                </li>
                <li class="nav-item">
